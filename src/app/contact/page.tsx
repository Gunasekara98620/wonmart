      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <a 
                      href="https://wa.me/94765381520"  //Sales Manager Whatsapp
                      target="_blank" 
          ...
          <div>
            ...
            {/* Map */}
            <div className="bg-white bg-opacity-80 rounded-xl shadow-lg p-8 mt-8">
              <h3 className="text-2xl font-bold text-gray-900 mb-6">Our Location</h3>
              <div className="w-full h-80">
                <iframe 
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3961.5786871088417!2d80.9841303740144!3d6.774166921241904!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3ae67a560958a761%3A0x2c70a0d8c0d8d8d8!2s206%2C%20Rolawatta%2C%20Meegama%2C%20Darga%20Town!5e0!3m2!1sen!2slk!4v1698745623456!5m2!1sen!2slk" 
                  width="100%" 
                  height="100%" 
                  style={{ border: 0 }} 
                  allowFullScreen 
